<?php
##
## Program: pnp4nagios-0.6.13 , Performance Data Addon for Nagios(r)
## License: GPL
...
#
$conf['rrdtool'] = "/usr/local/groundwork/common/bin/rrdtool";
#
...
#
$conf['rrdbase'] = "/usr/local/groundwork/pnp/var/perfdata/";
#
# Location of "page" configs
#
$conf['page_dir'] = "/usr/local/groundwork/pnp/etc/pages/";
#
...
#
$conf['background_pdf'] = '/usr/local/groundwork/pnp/etc/background.pdf' ;
...
$views[] = array('title' => '8 Hours',   'start' => (60*60*8) );
$views[] = array('title' => '25 Hours',  'start' => (60*60*25) );
$views[] = array('title' => '50 Hours',  'start' => (60*60*50) );
...
# /usr/local/groundwork/pnp/share/templates.dist is always the last directory to be searched for templates
#
# Add your own template directories here
# First match wins!
#$conf['template_dirs'][] = '/usr/local/check_mk/pnp-templates';
$conf['template_dirs'][] = '/usr/local/groundwork/pnp/share/templates';
$conf['template_dirs'][] = '/usr/local/groundwork/pnp/share/templates.dist';

#
# Directory to search for special templates
#
$conf['special_template_dir'] = '/usr/local/groundwork/pnp/share/templates.special';
