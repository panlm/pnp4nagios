...
$services = $this->tplGetServices("isv|ent|localhost","check_snmp_cpu_detail");
...
foreach($services as $key=>$val){
    ...
    $opt[$i]     = "--vertical-label \"Util(%)\" -l0 --title \" \" -u 10 ";
    $def[$i]     = "";
    #
...
$services = $this->tplGetServices("isv|ent|localhost","check_snmp_cpu_w");
