...
#$services = $this->tplGetServices("YJDDC-FW","check_snmp_port_isv(5|6|10|16|21|22|23|24|25|26|29|31|33)");
$services = $this->tplGetServices("YJDDC-FW","check_snmp_port_isv(6|16|22|25|26|28|36|39|46)");

#
# The Name of this Datasource (ds)
$ds_name[0] = "In"; 
$opt[0]     = "--vertical-label \" \" -l0 --title \"Top Bandwidth Utilization (bps)\" -w 800 -h 200 ";
$def[0]     = "";
...
# The Name of this Datasource (ds)
$ds_name[1] = "Out";
$opt[1]     = "--vertical-label \" \" -l0 --title \"Top Bandwidth Utilization (bps)\" -w 800 -h 200 ";
$def[1]     = "";
