...
$def[0] .= rrd::line2("var1", rrd::color(2), "Read KB/s") ;
$def[0] .= rrd::gprint("var1", array("LAST", "AVERAGE", "MAX"), "%6.2lf");
$def[0] .= rrd::line2("var2", rrd::color(3), "Write KB/s") ;
...
$opt[1] .= "--vertical-label \"requests\" -l0  --title \"$ds_name[1] for $hostname\" --units-exponent=0 ";

$def[1] .= rrd::def("var1", $RRDFILE[1], $DS[3], "AVERAGE");
$def[1] .= rrd::def("var2", $RRDFILE[1], $DS[4], "AVERAGE");

$def[1] .= rrd::line2("var1", rrd::color(2), "Read/s") ;
$def[1] .= rrd::gprint("var1", array("LAST", "AVERAGE", "MAX"), "%6.2lf");
$def[1] .= rrd::line2("var2", rrd::color(3), "Write/s") ;
